...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 2
    if num_rolls == 0:
        this_turn = free_bacon(opponent_score)
    else:
        this_turn = roll_dice(num_rolls, dice)
        if this_turn >= 25:


    if is_prime(this_turn):
        return  hogtimus_prime(this_turn)
    else:
        return this_turn
    # END PROBLEM 2
